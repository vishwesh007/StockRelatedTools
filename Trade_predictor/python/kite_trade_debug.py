...
class KiteApp:
    ...
    def instruments(self, exchange=None):
        logging.debug("Fetching instruments...")
    ...
    def margins(self):
        logging.debug("Fetching margins...")
    ...
    def cancel_order(self, variety, order_id, parent_order_id=None):
        logging.debug("Cancelling order...")
...
instruments = app.instruments(exchange="NSE")
quote_data = app.quote(instruments[0]["instrument_token"])
print(quote_data)
